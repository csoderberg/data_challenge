...
police_percent_pay <- pay_by_dept %>% filter(dept_name == 'Police Department') %>% select(percent_regular)
police_percent_ot <- pay_by_dept %>% filter(dept_name == 'Police Department') %>% select(percent_overtime)
police_ot <- pay_by_dept %>% filter(dept_name == 'Police Department') %>% select(tot_overtime)
